...
#include <OpenSR/World/DesertPlanet.h>
...
namespace Python
{
struct DesertPlanetWrap: DesertPlanet, boost::python::wrapper<DesertPlanet>
{
    DesertPlanetWrap(uint64_t id = 0): DesertPlanet(id)
    {
    }

    WORLD_PYTHON_WRAP_WORLD_OBJECT(DesertPlanet)
};
