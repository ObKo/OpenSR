...
void exportTypes()
{
    ...
    class_<BezierCurve>("BezierCurve", init<const Vector&, const Vector&, const Vector&, const Vector&>())
    .def(init<>())
    .def_readwrite("p0", &BezierCurve::p0)
    .def_readwrite("p1", &BezierCurve::p1)
    .def_readwrite("p2", &BezierCurve::p2)
    .def_readwrite("p3", &BezierCurve::p3);
