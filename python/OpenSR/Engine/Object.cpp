...
void setPosition(Object& self, boost::python::object pos)
{
...
void setColor(Object& self, boost::python::object pos)
{
...
void exportObject()
{
    ...
    c.add_property("position", &Object::position, &setPosition)
    .add_property("rotation", &Object::rotation, &Object::setRotation)
    .add_property("color", &Object::color, &setColor)
