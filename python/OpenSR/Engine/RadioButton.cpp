...
{
    RadioButtonWrap(boost::shared_ptr<RadioButtonStyle> style, const std::string &text)
...
void exportRadioButton()
{
    ...
    class_<RadioButtonWrap, bases<Button>, boost::shared_ptr<RadioButtonWrap>, boost::noncopyable> c("RadioButton", init<boost::shared_ptr<RadioButtonStyle>, const std::string&>());
