...
struct LabelWrap : SpriteWrap_<Label>
{
    ...
    LabelWrap(const std::string& text, Object *parent = 0, boost::shared_ptr<Font> font = boost::shared_ptr<Font>(), SpriteXOrigin xpos = POSITION_X_LEFT, SpriteYOrigin ypos = POSITION_Y_TOP)
...
void exportLabel()
{
    ...
    .def(init<const std::string&, Object*>())
